import { BrandsList } from "./Brands.style";
...
const brands = [
  {
    ...
    name: "Brand Name",
    snippet: "Long headline to turn",
    caption:
      "Long headline to turn your visitors into users Long headline to turn your visitors into users",
